    ...
    if (data.length) {
        ...
        if (typeof data === 'string' || !possiblyEnc) {
            ...
            try {
                ...
                if (!macKey || !encKey) {
                    throw new boom_1.Boom('recieved encrypted buffer when auth creds unavailable', { data: message, statusCode: Models_1.DisconnectReason.badSession });
                }
                /*
                ...
                */
                ...
                if (checksum.equals(computedChecksum)) {
                    ...
                    json = Internal_1.decodeBinaryNodeLegacy(decrypted, { index: 0 }); // decode the binary message into a JSON array
                }
                else {
                    throw new boom_1.Boom('Bad checksum', {
                        ...
                        statusCode: Models_1.DisconnectReason.badSession
                    });
                }
            }
        }
...
const validateNewConnection = (json, auth, curveKeys) => {
    ...
    const onValidationSuccess = () => {
        const user = {
            id: Internal_1.jidNormalizedUser(json.wid),
            name: json.pushname
        };
